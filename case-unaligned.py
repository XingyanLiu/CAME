...
print(f'Tissue:\t{tiss}', f'ref: {sp1}\t{dsn1}', f'que: {sp2}\t{dsn2}', sep='\n')
...
avg_expr1 = pp.group_mean_adata(adata_raw1, groupby=key_class1, features=dpair.vnode_names1, use_raw=True)
avg_expr2 = pp.group_mean_adata(adata_raw2, groupby=key_class2, features=dpair.vnode_names2, use_raw=True)
#adata_raw1.X.data
...
df_top2 = pp.compute_and_get_DEGs(adata2, 'predicted', unique=False, )# line 749
...
ovby = ['expr', 'attn'][0]
groupby_var = 'module'
obs_labels1, obs_labels2 = adt.obs['celltype'][dpair.obs_ids1], adt.obs['celltype'][dpair.obs_ids2]
